...
python3 eval_models.py --encoder_depth $ENCODER_DEPTH --decoder_depth $DECODER_DEPTH --train_data $TRAIN_DATA --width_multiplier $WIDTH_MULTIPLIER --prior_knowledge $PRIOR_KNOWLEDGE_PATH --relationships_filter $RELATIONSHIPS_FILTER
