...
sys.path.insert(1,'/home/schaferd/ae_project/attempt2/transcriptomics_autoencoder/model_analysis/ko_tests/ae_roc/')
...
class getROCCurve():
    def __init__(self,ae_args={}):
        ...
        print("activity file",self.activity_files)
    ...
    def get_roc(self):
        ...
        results = {'rank':positives}
        if len(self.ae_args.keys()) > 0:
            with open(self.ae_args['out_dir']+"/pos_neg"+str(self.fold)+".txt",'w') as f:
