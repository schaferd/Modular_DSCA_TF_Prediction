...
def create_const_figs(fig,label_font_size,title_font_size,subtitle_font_size):
    ax = fig.subplots(1,4,sharey=True, gridspec_kw={'width_ratios': [3,3,3,1.5]})
    fig.subplots_adjust(left=0.2,bottom=0.2,right=0.8,top=0.8,wspace=0.12,hspace=2)
    ...
    fig.suptitle("Ranking Consistency Between Trained Models", fontsize='x-large',y=0.97)
